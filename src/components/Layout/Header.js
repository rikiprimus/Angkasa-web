    ...
    return (
      <div className="w-full flex items-center justify-between">
        <FaPlaneDeparture
          size={250}
          color="#41A4FF"
          className="-rotate-[12deg] absolute -bottom-20 -left-8 -z-10"
        />
        ...
        {/* button search */}
        <button className="font-bold text-white p-4">Change Search</button>
      </div>
    );
  };
